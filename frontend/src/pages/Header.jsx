...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-[#040617]/60 backdrop-blur-lg border-b border-white/6">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-3">
            <motion.img src={Logo} alt="IntentSwap" className="h-9 w-9" whileHover={{ rotate: 8 }} />
            <span className="hidden md:inline text-white text-lg font-semibold">IntentSwap</span>
          </Link>
{/* 
